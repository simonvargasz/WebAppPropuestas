              ...
              <div class="card bg-dark border-2 m-2 rounded-4" data-bs-theme="dark">
                <div class="card-header border-2 rounded-4 shadow-sm m-0">
                  <div class="row p-0 m-0">
                    ...
                    <div class="col-4 p-0 m-0">
                      <h3 class="text-white text-center">Lista De Profesores</h3>
                    </div>
                  </div>
                </div>
                  ...
                  @foreach($profesores as $profesor)
                    <li class="list-group-item d-flex border-2 shadow-sm pe-0 justify-content-between rounded-4 mb-3 align-items-start">
                      <div class="ms-2 me-auto">
                        <div class="fw-bold text-white">{{$profesor->nombre}} {{$profesor->apellido}}</div>
                        <span>Rut: {{$profesor->rut}} </span>
                      </div>
                      <div class="col-2 d-flex justify-content-center border-start border-2 pb-2">
                        <a href="{{route('admin.verProfesor',['rut' => $profesor->rut])}}" class="btn btn-secondary border border-2 border-info rounded-5 shadow-sm" tabindex="-1" role="button" aria-disabled="true">Modificar <i class="fa-solid fa-arrow-right"></i></a>
                      </div>
